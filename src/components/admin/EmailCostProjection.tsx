...
const implementationSteps = {
  resend: [
    ...
    {
      title: '2. Domínio de envio (por cliente)',
      description: 'Cada cliente configura seu próprio domínio na página "Domínio E-mail" do sistema.',
      details: [
        'O cliente acessa Domínio E-mail → Adicionar Domínio',
        'O sistema gera automaticamente os registros DNS necessários (SPF, DKIM, DMARC)',
        'O cliente configura os registros no seu provedor de DNS',
        'O sistema verifica automaticamente a configuração via DNS lookup',
        'Isso garante que cada cliente envie e-mails com seu próprio domínio (ex: contato@empresa-dele.com)',
      ],
    },
    {
      title: '3. Gerar API Key',
      description: 'Crie uma chave de API para autenticação da plataforma com o Resend.',
      details: [
        'No dashboard Resend, vá em "API Keys" → "Create API Key"',
        'Dê um nome descritivo (ex: "AG Sell Production")',
        'Selecione permissões "Sending access" para todos os domínios',
        'Copie e guarde a chave gerada (ela só aparece uma vez)',
      ],
    },
    {
      title: '4. Configurar integração no AG Sell',
      description: 'Adicione as credenciais na plataforma (nível admin).',
      details: [
        'Acesse Integrações → E-mail → Resend (painel admin)',
        'Cole a API Key gerada',
        'A API Key é global — cada cliente usa seu próprio domínio verificado',
    ...
    },
    {
      ...
      details: [
        ...
        'Monitore a reputação de cada domínio de cliente',
  ...
  ses: [
    ...
    {
      title: '3. Domínio de envio (por cliente)',
      description: 'Cada cliente configura DKIM, SPF e DMARC em seu próprio domínio.',
      details: [
        'O cliente acessa a página "Domínio E-mail" no sistema',
        'O sistema gera os registros DNS necessários automaticamente',
        'O cliente adiciona SPF (TXT), DKIM (CNAME) e DMARC (TXT) no seu DNS',
        'O sistema verifica automaticamente via consulta DNS pública',
        'Cada domínio verificado pode ser usado como remetente via SES',
        'Os domínios dos clientes devem ser adicionados como identidades no SES via API',
      ],
    },
    {
    ...
    },
    {
      ...
      description: 'Adicione as credenciais AWS na plataforma (nível admin).',
      details: [
        'Acesse Integrações → E-mail → Amazon SES (painel admin)',
        'Insira o Access Key ID e Secret Access Key',
        'Selecione a região AWS configurada',
        'A API é global — cada cliente usa seu domínio verificado via a página Domínio E-mail',
        'Teste enviando um e-mail de teste com um domínio verificado',
      ],
    },
    {
      ...
      details: [
        ...
        'Use o SES Dashboard para acompanhar reputação por domínio de cliente',
