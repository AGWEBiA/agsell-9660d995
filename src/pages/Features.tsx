...
export default function Features() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Funcionalidades — CRM, WhatsApp, E-mail e IA"
        description="Explore as mais de 100 funcionalidades da AG Sell: Pipeline Kanban, WhatsApp multi-instância, E-mail Marketing, Agentes IA, Inbox Omnichannel e muito mais."
      />
      {/* Header */}
