...
import { Brain, Mail, MessageSquare, Workflow, Sparkles, Copy, Loader2 } from 'lucide-react';
...
export default function AIBuilder() {
  ...
  const typeConfig: Record<BuilderType, { label: string; icon: React.ReactNode; placeholder: string }> = {
    email_campaign: {
      ...
      placeholder: 'Ex: Crie um e-mail de boas-vindas para novos clientes de um SaaS de marketing, tom profissional mas amigável...',
    },
    automation_flow: {
      label: 'Fluxo de Automação',
      icon: <Workflow className="h-4 w-4" />,
      placeholder: 'Ex: Crie um fluxo de nutrição de leads com 5 etapas, começando por e-mail de boas-vindas, seguido de conteúdo educativo...',
    },
    subject_line: {
      label: 'Assuntos de E-mail',
      icon: <Sparkles className="h-4 w-4" />,
      placeholder: 'Ex: Gere assuntos para uma promoção de 50% de desconto no plano anual...',
    },
    whatsapp_message: {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Use IA generativa para criar campanhas, automações e mensagens</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>O que deseja criar?</CardTitle>
          </CardHeader>
