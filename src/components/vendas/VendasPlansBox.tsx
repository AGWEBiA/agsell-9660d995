...
import { GuestCheckoutDialog } from '@/components/pricing/GuestCheckoutDialog';
  ...
  return (
    <div className={className}>
      ...
      <div className={cn(
        ...
        variant === 'compact' ? 'grid-cols-2 md:grid-cols-4' : 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4'
      )}>
